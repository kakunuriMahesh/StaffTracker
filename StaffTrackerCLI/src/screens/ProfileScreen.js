...
const ProfileScreen = ({ navigation }) => {
  ...
  const { staffList, plan, isPremium, isPlanActive, user, logout } = useApp();
    ...
    Alert.alert(
      ...
      [
        { text: 'Later', style: 'cancel' },
        {
          ...
          onPress: () =>
            openURL(
              'https://play.google.com/store/apps/details?id=com.srcdesigns.StaffTracker',
              'Play Store'
            ),
        },
      ]
  ...
  const getPlanLabel = () => {
    if (plan.type === 'Premium') return 'Premium';
      ...
      <ScrollView contentContainerStyle={styles.content}>
            ...
            <View style={styles.menuItemLeft}>
              <View
                style={[
                  styles.menuIcon,
                  {
                    backgroundColor: planDetails.isActive ? '#DCFCE7' : '#FEE2E2',
                  },
                ]}
              >
                <Icon
                  name="card"
                  size={20}
                  color={planDetails.isActive ? '#16A34A' : '#DC2626'}
                />
              </View>
              <View>
                ...
                <Text style={styles.menuSubtitle}>
                  {getPlanLabel()}
                  {plan.type !== 'free' && plan.type !== 'lifetime' && plan.expiryDate
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              openURL(
                'https://lemonchiffon-heron-497115.hostingersite.com/terms-conditions-staffTracker.html',
                'Terms & Conditions'
              )
            }
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuIcon, { backgroundColor: '#EEF2FF' }]}>
                <Icon name="document-text" size={20} color="#4F46E5" />
              </View>
              <View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              openURL(
                'https://lemonchiffon-heron-497115.hostingersite.com/PricacyPolicy-StaffTracker.html',
                'Privacy Policy'
              )
            }
          >
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={handleShareApp}>
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuIcon, { backgroundColor: '#FEE2E2' }]}>
                <Icon name="share-social" size={20} color="#DC2626" />
              </View>
              <View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              openURL(
                'mailto:support@stafftracker.app?subject=StaffTracker Support',
                'Email Support'
              )
            }
          >
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Made with love for Households</Text>
          <Text style={styles.copyright}>
            (c) 2025 StaffTracker. All rights reserved.
          </Text>
        </View>
      </ScrollView>
    </View>
